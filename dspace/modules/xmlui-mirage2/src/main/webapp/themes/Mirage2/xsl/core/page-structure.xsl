...
<xsl:stylesheet xmlns:i18n="http://apache.org/cocoon/i18n/2.1"
            ...
            &lt;!--[if gt IE 8]&gt;&lt;!--&gt; &lt;html class=&quot;no-js&quot; lang=&quot;en&quot;&gt; &lt;!--&lt;![endif]--&gt;
                ...
                <body>
                   ...
                   chromium.org/developers/how-tos/chrome-frame-getting-started -->
                    ...
                    <!-- GUCODE[[twb27]]-->
                    <xsl:call-template name="gu-theme-specific-resources"/>
                </body>
    ...
    <xsl:template name="buildHead">
        <head>
            ...
            <link rel="shortcut icon" href="/favicon.ico?x=2" type="image/x-icon" />
            ...
            <!-- GUCODE[[twb27: allow all cust themes to share css]]-->
            <link rel="stylesheet" href="/themes/Mirage2/styles/main.css"/>
            ...
            <!-- GUCODE[[twb27: microtagging]]-->
            <script type="application/ld+json">
            {  "@context" : "http://schema.org",
               "@type" : "WebSite",
               "name" : "DigitalGeorgetown",
               "url" : "http://repository.library.georgetown.edu"
            }
            </script>   
            ...
            <!-- GUCODE[[twb27: selective display of scholar metadata]]-->
            <xsl:if test="$SHOW_SCHOLAR">
                <xsl:for-each select="/dri:document/dri:meta/dri:pageMeta/dri:metadata[substring(@element, 1, 9) = 'citation_']">
                    <meta name="{@element}" content="{.}"></meta>
                </xsl:for-each>
                <xsl:for-each select="/dri:document/dri:meta/dri:pageMeta/dri:metadata[@element = 'citation_date']">
    ...
    <!-- GUCODE[[twb27: allow theme specific CSS and JS inclusion]]-->
    <xsl:template name="gu-theme-specific-resources">
    </xsl:template>
            ...
            <div class="navbar navbar-default navbar-static-top" role="navigation">
                <div class="container">
                    <div class="navbar-header">
                        ...
                        <!-- GUCODE[[twb27: add GU logos]]-->
                        <a href="http://www.georgetown.edu" class="navbar-brand hidden-xs hidden-sm" title="Georgetown University Home">
                            <img src="/themes/Mirage2/images/gu-nameplate.png" alt="Georgetown University Logo"/>
                        </a>
                        <a href="http://library.georgetown.edu" class="navbar-brand hidden-xs" title="Georgetown University Library Home">
                            <img src="/themes/Mirage2/images/GUL-inverted-logo-40.png" alt="Georgetown University Library Logo"/>
                        </a>
                        <a href="{$DGHOME}/" class="navbar-brand" title="DigitalGeorgetown Home">
                            <img src="/themes/Mirage2/images/digitalgeorgetown-logo-small-inverted.png" alt="DigitalGeorgetown Home" />
                        </a>
                    ...
                    <div class="col-xs-12">
                        <xsl:choose>
                            <xsl:when test="count(/dri:document/dri:meta/dri:pageMeta/dri:trail) > 1">
                                ...
                                <!-- GUCODE[[twb27: breadcrumb microtags]]-->
    ...
    <xsl:template match="dri:trail">
        ...
        <!-- GUCODE[[twb27: breadcrumb microtags; add microtag properties]]-->
        <li itemprop="itemListElement" itemscope="" itemtype="http://schema.org/ListItem">
            ...
            <xsl:choose>
                <!-- GUCODE[[twb27: override top breadcrub link]]-->
                <xsl:when test="position()=1">
                    <a href="{$DGHOME}" itemprop="item">
                        <span itemprop="name">
                            <xsl:apply-templates />
                        </span>
                    </a>
    ...
    <xsl:template name="buildFooter">
        <footer>
                <div class="row">
                    <hr/>
                    <!-- GUCODE[[twb27: customize footers]]-->
                    <div class="col-xs-5 col-sm-4 hidden-print gufooter" style="width: 100%;">
                        <img alt="Georgetown University Seal" src="/themes/Mirage2/images/gu-seal.png" class="guseal"/>
                        <div class="pull-right">
                            <xsl:call-template name="guFooterText"/>
                        </div>
                    </div>
                </div>
    ...
    <xsl:template name="guFooterText">
        ...
        <xsl:text> Georgetown University Library</xsl:text>
        <br/> 
        <xsl:text>37th &amp; O Streets NW </xsl:text>
        <br/>
        <xsl:text>Washington DC 20057-1174</xsl:text>
        <br/>
        <xsl:text>202.687.7385 </xsl:text>
        <br/>
        <a  class="gulink" href="mailto:digitalscholarship@georgetown.edu">digitalscholarship@georgetown.edu</a><br/> 
    </xsl:template>

    <xsl:template name="getCopyrightYear"><xsl:value-of select="substring(date:date-time(),1,4)"/></xsl:template>


    <!-- GUCODE[[twb27: add cusom image/logo to community/collection home page]]-->
   ...
   <!--
    ...
    <xsl:template match="dri:body">
        <div>
            <!-- GUCODE[[twb27: add microtag item type]]-->
            <xsl:call-template name="microtag-wrapper"/>
